    ...
    <div className={styles.layout}>
      ...
      <aside className={styles.sidebar}>
        ...
        <nav className={styles.sidebarNav}>
          ...
          <Link href="/prescriptions" className={`${styles.navItem} ${pathname === '/prescriptions' ? styles.navActive : ''}`}>
            <span className={styles.navIcon}>📁</span>
            Vault
          </Link>
          <Link href="/orders" className={`${styles.navItem} ${pathname === '/orders' ? styles.navActive : ''}`}>
          ...
          <Link href="/settings" className={`${styles.navItem} ${pathname === '/settings' ? styles.navActive : ''}`}>
            <span className={styles.navIcon}>⚙️</span>
            Settings
          </Link>
        </nav>
