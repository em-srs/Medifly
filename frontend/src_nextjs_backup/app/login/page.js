      ...
      <div className={styles.container} ref={pageRef}>
        <div className={styles.left} data-reveal="left" data-delay="0">
          ...
          <div className={styles.features}>
            <div className={styles.feature}><span>⚡</span> Quick 1–6 hour delivery</div>
            <div className={styles.feature}><span>🔬</span> Salt comparison tool</div>
            <div className={styles.feature}><span>🔄</span> Auto-refill for chronic meds</div>
            <div className={styles.feature}><span>🔒</span> Secure prescription vault</div>
          </div>
        </div>
          ...
          <div className={styles.card}>
            ...
            {step === 'otp' && (
              <div className={styles.form}>
                ...
                <p className={styles.demoHint}>💡 Demo: Enter any 6 digits</p>
              </div>
            )}
            ...
            {step === 'role' && (
              <div className={styles.form}>
                ...
                <div className={styles.roles}>
                  {[
                    { id: 'user', label: 'Patient / User', icon: '👤', desc: 'Order medicines, manage prescriptions' },
                    { id: 'pharmacy', label: 'Pharmacy Partner', icon: '🏥', desc: 'Manage orders and stock' },
                    { id: 'rider', label: 'Delivery Rider', icon: '🚴', desc: 'Deliver medicines' },
                    { id: 'admin', label: 'Administrator', icon: '🛡️', desc: 'Manage the platform' },
                  ].map(r => (
                    <button
                      key={r.id}
