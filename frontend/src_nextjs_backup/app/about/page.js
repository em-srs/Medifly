            ...
            <div className={styles.whyGrid}>
              ...
              <div className={styles.whyStats}>
                {[
                  ...
                  { icon: '✓',  stat: '100%',   label: 'Compliance Rate',        delay: '100' },
                  { icon: '🚚', stat: '24/7',   label: 'Dispatch Operations',    delay: '200' },
                  { icon: '🛡️', stat: 'Secure', label: 'Chain of Custody',       delay: '300' },
                ].map((s) => (
        ...
        <section className={styles.teamSection} ref={teamRef}>
          <div className={styles.container}>
            ...
            <div className={styles.teamGrid}>
              {[
                { icon: '👨‍⚕️', title: 'Licensed Pharmacists', desc: 'Every order is vetted by our clinical team. They oversee prescription validation and provide real-time consultations for complex therapies.', delay: '0' },
                ...
                { icon: '🚚',  title: 'Logistics Experts',     desc: 'Specialists in cold-chain management and rapid urban transit, ensuring medications are handled with absolute care.', delay: '240' },
              ].map((card) => (
            ...
            <div className={styles.trustGrid}>
              ...
              <div className={styles.trustContent}>
                ...
                <div className={styles.trustItems}>
                  {[
                    { icon: '✓',   title: 'Licensed Partner Pharmacies', desc: 'We exclusively partner with accredited brick-and-mortar pharmacies, ensuring every pill comes from a trusted, legal source.', delay: '100' },
                    { icon: '🛡️', title: 'Schedule H Drug Safety',       desc: 'Our protocol for controlled substances exceeds federal requirements, with dual-factor verification and tamper-evident packaging.', delay: '200' },
                    { icon: '❄️',  title: 'Cold-Chain Excellence',        desc: 'Temperature-sensitive medications like insulin are transported in IoT-monitored containers to maintain efficacy.', delay: '300' },
                  ].map((item) => (
          ...
          <div className={styles.container}>
            <div className={styles.ctaBox} data-reveal="scale" data-delay="0">
              ...
              <div className={styles.ctaBtns}>
                <Link href="/medicines" className={`btn ${styles.btnDark}`}>Order Now</Link>
                <Link href="/contact"   className={`btn ${styles.btnOutlineTeal}`}>Partner With Us</Link>
              </div>
            </div>
          </div>
        </section>
