          ...
          <div className={styles.heroGrid}>
            <div className={styles.heroContent}>
              ...
              <div className={styles.heroButtons} data-reveal="true" data-delay="240">
                <Link href="/medicines" className={`btn btn-primary ${styles.btnOrder}`}>
                  <span className={styles.btnIcon}>🛒</span> Order Medicines
                </Link>
                <Link href="/prescriptions" className={`btn btn-outline ${styles.btnUpload}`}>
                  <span className={styles.btnIcon}>📁</span> Upload Prescription
                </Link>
              </div>
          ...
          <div className={styles.failsGrid}>
            ...
            <div className={styles.cardInfo} data-reveal="true" data-delay="120">
              <div className={`${styles.iconCircle} ${styles.iconOrange}`}>
                <span className={styles.iconInside}>🛡️</span>
              </div>
          ...
          <div className={styles.stepsLayout}>
            <div className={styles.stepsLeft}>
              ...
              <div className={styles.stepperContainer}>
                {[
                  { icon: '🔍', title: 'Search & Order',           desc: 'Select your medicines from our extensive verified catalog or simply upload your prescription photo.', active: true },
                  ...
                  { icon: '📦', title: 'Professional Packing',     desc: 'Medications are sealed in tamper-proof packaging. Sensitive items are placed in cold-chain storage.' },
                  { icon: '🚚', title: 'Rapid Last-Mile Delivery', desc: 'A dedicated MediFly rider picks up your order and delivers it to your doorstep in under 6 hours.' },
                ].map((step, i) => (
        ...
        <div className={styles.container}>
          ...
          <div className={styles.healthGrid}>
            {[
              ...
              { icon: '🔄', title: 'Salt Comparison',  desc: 'Save up to 70% by comparing different brands with the same chemical composition.' },
      ...
      <section className={styles.trustedBlock} ref={trustRef}>
        <div className={styles.container}>
          ...
          <div className={styles.trustedGrid}>
            {[
              { icon: '🛡️', text: 'CDSCO COMPLIANT' },
              { icon: '🏅', text: 'ISO 9001 CERTIFIED' },
              { icon: '🏥', text: 'LICENSED PHARMACY' },
              { icon: '🔒', text: 'UPI & SECURE PAYMENTS' },
            ].map((badge, i) => (
        ...
        <div className={styles.container}>
          <div className={styles.ctaBoxWrap} data-reveal="scale" data-delay="0">
            <div className={styles.ctaBox}>
              ...
              <Link href="/medicines" className={`btn btn-primary ${styles.btnPlaceOrder}`}>
