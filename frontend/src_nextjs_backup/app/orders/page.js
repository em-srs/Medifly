...
import styles from '../prescriptions/page.module.css';
...
const ORDERS = [
  ...
  },
  {
    ...
    items: '1× Insulin Glargine 100 IU/ml (Lantus) — ❄️ Cold Chain',
              ...
              <div key={i} data-reveal="true" data-delay={i * 80} style={{ backgroundColor: 'white', border: '1px solid var(--slate-100)', borderRadius: 'var(--radius-xl)', padding: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.75rem', marginTop: '1rem' }}>
                  {order.status === 'OUT FOR DELIVERY' && (
                    <button className="btn btn-primary" style={{ padding: '0.5rem 1.1rem', fontSize: '0.85rem' }}>🗺️ Track Live</button>
                  )}
