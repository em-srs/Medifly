    ...
    <div className={styles.container}>
      ...
      <div className={styles.hubsSection} ref={hubsRef}>
        ...
        <div className={styles.hubsGrid}>
          {[
            { cls: styles.hubSf,        city: 'Mumbai, Maharashtra',  role: 'National Headquarters',   addr: ['Unit 14, Oberoi Commerz II', 'Goregaon East', 'Mumbai – 400 063'], delay: '0' },
            { cls: styles.hubLondon,    city: 'Bengaluru, Karnataka', role: 'Tech & Engineering Hub',  addr: ['WeWork, Prestige Atlanta', '80 Feet Road, Koramangala', 'Bengaluru – 560 034'], delay: '120' },
            { cls: styles.hubSingapore, city: 'Delhi NCR',            role: 'North India Operations', addr: ['DLF Cyber City, Tower 9A', 'Sector 25, Phase II', 'Gurugram, Haryana – 122 002'], delay: '240' },
          ].map((hub) => (
